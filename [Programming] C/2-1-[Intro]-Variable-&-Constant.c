...
// 2) 全局变量 (定义在 代码块{} 之外的变量量, 全局变量在哪都可以使用)
...
// Example 2 (To show scope of global variable (from another source file))
// - - - - - - - - - -
//int main(void)
//{
//    // extern 用于声明外部符号
//    extern int v2;  // From Variable & Constant 2.c
//    printf("v2 = %d\n", v2);
//    return 0;
//}
// - - - - - - - - - -
...
// Example 3 ( (4) Enumeration constant 枚举常量 )
// - - - - - - - - - -
//enum Color // enum 枚举的关键字
//{
//    // Color 所可能的取值 (枚举常量)
//    RED,
//    GREEN,
